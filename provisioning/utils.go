...
func getServerInternalIP(client kubernetes.Interface, targetNamespace string, config *metal3iov1alpha1.ProvisioningSpec, osclient osclientset.Interface) (string, error) {
...
func GetIronicIP(client kubernetes.Interface, targetNamespace string, config *metal3iov1alpha1.ProvisioningSpec, osclient osclientset.Interface) (ironicIP string, inspectorIP string, err error) {
	...
	if UseIronicProxy(config) {
		ironicIP, err = getServerInternalIP(client, targetNamespace, config, osclient)
	} else {
